...
Step-by-step commands for assembling the bootloader, compiling the Rust/C kernel, and wrapping everything into an El Torito ISO live in [`OS_Build/BUILDING.md`](OS_Build/BUILDING.md).
