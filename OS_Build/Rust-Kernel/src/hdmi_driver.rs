...
pub fn read_edid() -> DisplayCapabilities {
...
pub fn configure_display(capabilities: DisplayCapabilities) {
    set_timing_parameters(capabilities.resolution);
    configure_pixel_format(capabilities.color_depth);
}

pub fn allocate_framebuffer(resolution: Resolution, color_depth: ColorDepth) {
...
pub fn configure_audio_stream(format: AudioFormat, sample_rate: u32) {
...
pub fn calculate_pixel_offset(x: u32, y: u32) -> usize {
    (y * 1920 + x) as usize * 4
}
...
pub fn set_timing_parameters(_res: Resolution) {}
pub fn configure_pixel_format(_depth: ColorDepth) {}
pub fn hotplug_status() -> bool { false }
pub fn format_audio_stream(_format: AudioFormat) {}
